...
Description: Evaluate Multiple Models based on `R^2`, `Adjusted R^2` and `Root Mean Squared Error` Perofrmance Metrics. 
...
class EvaluateModels:
    ...
    def _get_adj_r2(self, r2: float) -> float:
        ...
        # adjust R^2
        n= len(self.X) # num of observations 
        p= self.X.shape[1] # num of predictors 
